...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/faissR_hnsw_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/faissR_hnsw_cuda_%j.err
...
# method="hnsw". Set METRICS to run one or more supported metrics;
# metric-specific wrappers include run_hpc_hnsw_tuning_cuda_euclidean.sh,
# run_hpc_hnsw_tuning_cuda_cosine.sh,
# run_hpc_hnsw_tuning_cuda_correlation.sh.
