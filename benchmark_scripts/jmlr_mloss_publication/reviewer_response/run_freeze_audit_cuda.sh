...
#SBATCH --job-name="frJ_freeze_cuda"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_freeze_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_freeze_cuda_%j.err
...
OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JMLR_MLOSS/reviewer_response/freeze/cuda_${STAMP}}"
