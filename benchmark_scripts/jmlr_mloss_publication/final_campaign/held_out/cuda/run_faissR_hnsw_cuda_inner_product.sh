...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_hnsw_cuda_inner_product_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_hnsw_cuda_inner_product_%j.err
...
export OUT_DIR="${BASE_DIR}/faissR_JMLR_MLOSS/final_campaign/held_out/cuda/faissR_hnsw/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)"
