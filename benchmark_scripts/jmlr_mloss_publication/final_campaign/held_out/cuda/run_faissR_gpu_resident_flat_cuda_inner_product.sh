...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_gpu_resident_flat_cuda_inner_product_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_gpu_resident_flat_cuda_inner_product_%j.err
...
export METHOD_LABEL='faissR_gpu_resident_flat_inner_product'
export BACKEND='cuda'
...
export OUT_DIR="${BASE_DIR}/faissR_JMLR_MLOSS/final_campaign/held_out/cuda/faissR_gpu_resident_flat/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)"
