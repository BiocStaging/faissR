...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_auto_cuda_inner_product_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_auto_cuda_inner_product_%j.err
