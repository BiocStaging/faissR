...
#SBATCH --job-name="frJ_h_cuda_ml_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_cuda_ml_knn_cuda_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_cuda_ml_knn_cuda_euclidean_%j.err
...
export METHOD_LABEL='cuda_ml_knn_euclidean'
export BACKEND='cuda'
...
export OUT_DIR="${BASE_DIR}/faissR_JMLR_MLOSS/final_campaign/held_out/cuda/cuda_ml_knn/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)"
