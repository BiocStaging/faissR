...
#SBATCH --job-name="frJ_h_uwot_ne_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_uwot_nearest_neighbors_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_uwot_nearest_neighbors_cpu12_euclidean_%j.err
...
export METHOD_ID='uwot_nearest_neighbors'
export METHOD_LABEL='uwot_nearest_neighbors_euclidean'
export BACKEND='cpu'
...
export REQUIRED_EXTERNAL_PACKAGE='uwot'
...
export OUT_DIR="${BASE_DIR}/faissR_JMLR_MLOSS/final_campaign/held_out/cpu/uwot_nearest_neighbors/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)"
