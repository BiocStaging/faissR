...
#SBATCH --job-name="frJ_h_RcppHNS_inne"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_RcppHNSW_hnsw_cpu12_inner_product_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_RcppHNSW_hnsw_cpu12_inner_product_%j.err
...
export METHOD_LABEL='RcppHNSW_hnsw_inner_product'
export BACKEND='cpu'
