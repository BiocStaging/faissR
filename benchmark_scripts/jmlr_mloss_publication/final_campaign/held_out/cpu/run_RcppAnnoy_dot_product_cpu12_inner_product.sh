...
#SBATCH --job-name="frJ_h_RcppAnn_inne"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_RcppAnnoy_dot_product_cpu12_inner_product_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_RcppAnnoy_dot_product_cpu12_inner_product_%j.err
...
export METHOD_ID='RcppAnnoy_dot_product'
export METHOD_LABEL='RcppAnnoy_dot_product_inner_product'
export BACKEND='cpu'
export THREADS="${THREADS:-12}"
export METHOD_METRICS='inner_product'
...
export REQUIRED_EXTERNAL_PACKAGE='RcppAnnoy'
...
export OUT_DIR="${BASE_DIR}/faissR_JMLR_MLOSS/final_campaign/held_out/cpu/RcppAnnoy_dot_product/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)"
