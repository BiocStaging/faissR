...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_ivf_cpu12_inner_product_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_ivf_cpu12_inner_product_%j.err
...
export OUT_DIR="${BASE_DIR}/faissR_JMLR_MLOSS/final_campaign/held_out/cpu/faissR_ivf/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)"
