...
#SBATCH --job-name="frJ_t_cagra_inne"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_cagra_cuda_inner_product_mips_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_cagra_cuda_inner_product_mips_%j.err
...
export METHOD='cagra'
export METHOD_LABEL='faissR_cagra_inner_product_mips'
export BACKEND='cuda'
