...
#SBATCH --job-name="frJ_t_nndesce_inne"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_nndescent_cuda_inner_product_mips_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_nndescent_cuda_inner_product_mips_%j.err
...
export METHOD_LABEL='faissR_nndescent_inner_product_mips'
export BACKEND='cuda'
...
export OUT_DIR="${BASE_DIR}/faissR_JMLR_MLOSS/final_campaign/calibration/mips/cuda/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)"
