...
#SBATCH --job-name="frJ_t_nsg_inne"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_nsg_cuda_inner_product_mips_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_nsg_cuda_inner_product_mips_%j.err
...
export METHOD='nsg'
export METHOD_LABEL='faissR_nsg_inner_product_mips'
export BACKEND='cuda'
