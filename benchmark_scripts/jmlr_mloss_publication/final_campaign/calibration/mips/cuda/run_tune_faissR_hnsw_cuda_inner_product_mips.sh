...
#SBATCH --job-name="frJ_t_hnsw_inne"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_hnsw_cuda_inner_product_mips_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_hnsw_cuda_inner_product_mips_%j.err
...
export METHOD='hnsw'
export METHOD_LABEL='faissR_hnsw_inner_product_mips'
export BACKEND='cuda'
