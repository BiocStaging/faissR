...
#SBATCH --job-name="frJ_t_ivfpq_f_inne"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_fastscan_cuda_inner_product_mips_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_fastscan_cuda_inner_product_mips_%j.err
...
export METHOD_LABEL='faissR_ivfpq_fastscan_inner_product_mips'
export BACKEND='cuda'
