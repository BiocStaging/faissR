...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_bruteforce_cuda_inner_product_mips_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_bruteforce_cuda_inner_product_mips_%j.err
...
export METHOD_LABEL='faissR_bruteforce_inner_product_mips'
export BACKEND='cuda'
