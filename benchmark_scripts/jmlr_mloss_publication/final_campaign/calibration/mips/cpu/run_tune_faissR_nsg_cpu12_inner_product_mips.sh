...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_nsg_cpu12_inner_product_mips_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_nsg_cpu12_inner_product_mips_%j.err
