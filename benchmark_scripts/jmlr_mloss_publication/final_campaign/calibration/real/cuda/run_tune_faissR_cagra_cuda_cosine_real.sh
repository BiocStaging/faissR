...
#SBATCH --job-name="frJ_t_cagra_cosi"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_cagra_cuda_cosine_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_cagra_cuda_cosine_real_%j.err
...
export METHOD='cagra'
export METHOD_LABEL='faissR_cagra_cosine_real'
export BACKEND='cuda'
