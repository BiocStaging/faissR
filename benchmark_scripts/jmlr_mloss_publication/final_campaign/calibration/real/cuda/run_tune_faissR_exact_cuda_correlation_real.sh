...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_exact_cuda_correlation_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_exact_cuda_correlation_real_%j.err
