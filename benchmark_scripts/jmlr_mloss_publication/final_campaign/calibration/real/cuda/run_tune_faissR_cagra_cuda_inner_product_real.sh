...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_cagra_cuda_inner_product_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_cagra_cuda_inner_product_real_%j.err
...
export METHOD='cagra'
export METHOD_LABEL='faissR_cagra_inner_product_real'
export BACKEND='cuda'
