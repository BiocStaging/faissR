...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_fastscan_cuda_cosine_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_fastscan_cuda_cosine_real_%j.err
