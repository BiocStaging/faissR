...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivf_cuda_euclidean_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivf_cuda_euclidean_real_%j.err
