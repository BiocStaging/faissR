...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_bruteforce_cuda_cosine_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_bruteforce_cuda_cosine_real_%j.err
