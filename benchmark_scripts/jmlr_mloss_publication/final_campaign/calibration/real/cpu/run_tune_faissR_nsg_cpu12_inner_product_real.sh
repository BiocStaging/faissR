...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_nsg_cpu12_inner_product_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_nsg_cpu12_inner_product_real_%j.err
...
export METHOD='nsg'
export METHOD_LABEL='faissR_nsg_inner_product_real'
export BACKEND='cpu'
