...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_nndescent_cpu12_inner_product_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_nndescent_cpu12_inner_product_real_%j.err
...
export METHOD_LABEL='faissR_nndescent_inner_product_real'
export BACKEND='cpu'
