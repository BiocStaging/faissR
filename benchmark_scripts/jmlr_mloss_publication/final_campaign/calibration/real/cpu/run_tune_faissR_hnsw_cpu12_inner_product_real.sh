...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_hnsw_cpu12_inner_product_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_hnsw_cpu12_inner_product_real_%j.err
...
export METHOD='hnsw'
export METHOD_LABEL='faissR_hnsw_inner_product_real'
export BACKEND='cpu'
