...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_fastscan_cpu12_inner_product_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_fastscan_cpu12_inner_product_real_%j.err
...
export METHOD_LABEL='faissR_ivfpq_fastscan_inner_product_real'
export BACKEND='cpu'
