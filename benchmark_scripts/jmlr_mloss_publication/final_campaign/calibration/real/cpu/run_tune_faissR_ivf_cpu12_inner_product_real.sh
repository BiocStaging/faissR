...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivf_cpu12_inner_product_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivf_cpu12_inner_product_real_%j.err
...
export METHOD='ivf'
export METHOD_LABEL='faissR_ivf_inner_product_real'
export BACKEND='cpu'
