...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_cpu12_inner_product_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_cpu12_inner_product_real_%j.err
...
export METHOD='ivfpq'
export METHOD_LABEL='faissR_ivfpq_inner_product_real'
export BACKEND='cpu'
