...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_exact_cpu12_inner_product_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_exact_cpu12_inner_product_real_%j.err
...
export METHOD='exact'
export METHOD_LABEL='faissR_exact_inner_product_real'
export BACKEND='cpu'
