...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_flat_cpu12_inner_product_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_flat_cpu12_inner_product_real_%j.err
...
export METHOD='flat'
export METHOD_LABEL='faissR_flat_inner_product_real'
export BACKEND='cpu'
