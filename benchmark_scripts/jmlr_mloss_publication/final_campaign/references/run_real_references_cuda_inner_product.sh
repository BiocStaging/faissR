...
#SBATCH --job-name="frJ_ref_inner"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_reference_real_cuda_inner_product_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_reference_real_cuda_inner_product_%j.err
...
run_r -e 'library(faissR); stopifnot(faissR::cuda_available(), faissR::faiss_gpu_available()); cat("CUDA exact-reference preflight OK\n")'
