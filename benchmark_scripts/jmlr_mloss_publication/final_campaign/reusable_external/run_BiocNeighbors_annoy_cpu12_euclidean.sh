...
#SBATCH --job-name="frJ_w_BiocNei_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_reusable_BiocNeighbors_annoy_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_reusable_BiocNeighbors_annoy_cpu12_euclidean_%j.err
