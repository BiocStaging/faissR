...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_reusable_BiocNeighbors_hnsw_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_reusable_BiocNeighbors_hnsw_cpu12_euclidean_%j.err
