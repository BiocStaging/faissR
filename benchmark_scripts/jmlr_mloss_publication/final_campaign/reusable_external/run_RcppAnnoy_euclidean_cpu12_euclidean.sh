...
#SBATCH --job-name="frJ_w_RcppAnn_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_reusable_RcppAnnoy_euclidean_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_reusable_RcppAnnoy_euclidean_cpu12_euclidean_%j.err
