...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_reusable_BiocNeighbors_annoy_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_reusable_BiocNeighbors_annoy_cpu12_cosine_%j.err
