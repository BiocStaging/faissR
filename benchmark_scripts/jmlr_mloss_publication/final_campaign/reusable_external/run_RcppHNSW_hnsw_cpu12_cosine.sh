...
#SBATCH --job-name="frJ_w_RcppHNS_cosi"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_reusable_RcppHNSW_hnsw_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_reusable_RcppHNSW_hnsw_cpu12_cosine_%j.err
