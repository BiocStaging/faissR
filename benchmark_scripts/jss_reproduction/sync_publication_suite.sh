...
TARGET_ROOT="$1"
TARGET_SUITE="${TARGET_ROOT}/benchmark_scripts/jss_reproduction"
...
echo "  Rscript benchmark_scripts/jss_reproduction/final_campaign/submit_campaign.R --phase=list"
echo "  Rscript benchmark_scripts/jss_reproduction/final_campaign/submit_campaign.R --phase=qa"
