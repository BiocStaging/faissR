...
The complete publication campaign is under
...
HPC; it verifies the generated launchers without running a benchmark.
...
faissR-auto time; selector regret is auto time over oracle time. Each dataset
