...
#SBATCH --job-name="frJ_rnndescent_bruteforce"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_rnndescent_bruteforce_cpu12_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_rnndescent_bruteforce_cpu12_%j.err
...
export METHOD_LABEL="rnndescent_bruteforce"
export BACKEND="cpu"
