...
#SBATCH --job-name="frJ_rcppannoy_euclidean"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_rcppannoy_euclidean_cpu12_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_rcppannoy_euclidean_cpu12_%j.err
...
export METHOD_LABEL="RcppAnnoy_euclidean"
export BACKEND="cpu"
