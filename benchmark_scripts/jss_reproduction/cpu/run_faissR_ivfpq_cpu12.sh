...
#SBATCH --job-name="frJ_faissr_ivfpq"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_faissr_ivfpq_cpu12_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_faissr_ivfpq_cpu12_%j.err
