...
#SBATCH --job-name="frJ_rnndescent_nnd"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_rnndescent_nnd_cpu12_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_rnndescent_nnd_cpu12_%j.err
...
export METHOD_LABEL="rnndescent_nnd"
export BACKEND="cpu"
