...
#SBATCH --job-name="frJ_rann_kd"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_rann_kd_cpu12_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_rann_kd_cpu12_%j.err
