...
#SBATCH --job-name="frJ_faissr_auto"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_faissr_auto_cpu12_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_faissr_auto_cpu12_%j.err
...
export METHOD_LABEL="faissR_auto"
export BACKEND="cpu"
