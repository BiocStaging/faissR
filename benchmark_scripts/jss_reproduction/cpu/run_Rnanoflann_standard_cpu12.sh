...
#SBATCH --job-name="frJ_rnanoflann_standard"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_rnanoflann_standard_cpu12_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_rnanoflann_standard_cpu12_%j.err
...
export METHOD_LABEL="Rnanoflann_standard"
export BACKEND="cpu"
