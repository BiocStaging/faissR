...
#SBATCH --job-name="frJ_rnndescent_rpf"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_rnndescent_rpf_cpu12_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_rnndescent_rpf_cpu12_%j.err
...
export METHOD_LABEL="rnndescent_rpf"
export BACKEND="cpu"
