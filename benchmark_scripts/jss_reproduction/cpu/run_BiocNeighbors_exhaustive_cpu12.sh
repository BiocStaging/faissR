...
#SBATCH --job-name="frJ_biocneighbors_exhaustive"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_biocneighbors_exhaustive_cpu12_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_biocneighbors_exhaustive_cpu12_%j.err
...
export METHOD_LABEL="BiocNeighbors_exhaustive"
export BACKEND="cpu"
