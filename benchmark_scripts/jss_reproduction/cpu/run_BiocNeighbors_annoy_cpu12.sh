...
#SBATCH --job-name="frJ_biocneighbors_annoy"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_biocneighbors_annoy_cpu12_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_biocneighbors_annoy_cpu12_%j.err
...
export METHOD_LABEL="BiocNeighbors_annoy"
export BACKEND="cpu"
