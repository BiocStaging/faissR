...
ROOT="${BASE_DIR}/faissR_JSS_REPRODUCTION/reviewer_response/external_r_comparison/cpu"
OUT="${BASE_DIR}/faissR_JSS_REPRODUCTION/reviewer_response/external_r_comparison/analysis_${SLURM_JOB_ID:-manual}_$(date -u +%Y%m%d_%H%M%S)"
