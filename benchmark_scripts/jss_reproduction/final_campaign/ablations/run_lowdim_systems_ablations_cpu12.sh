...
#SBATCH --job-name="frJ_abl_low_cpu"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_ablation_lowdim_cpu12_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_ablation_lowdim_cpu12_%j.err
...
export OUT_DIR="${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/ablations/cpu/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)"
exec bash "${SUITE_ROOT}/ablations/run_systems_ablations_cpu12.sh"
