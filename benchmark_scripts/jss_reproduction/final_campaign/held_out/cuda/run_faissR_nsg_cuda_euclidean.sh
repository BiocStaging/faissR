...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_nsg_cuda_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_nsg_cuda_euclidean_%j.err
