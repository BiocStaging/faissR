...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_ivfpq_cuda_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_ivfpq_cuda_cosine_%j.err
...
export METHOD_LABEL='faissR_ivfpq_cosine'
export BACKEND='cuda'
