...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_vamana_cuda_correlation_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_vamana_cuda_correlation_%j.err
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cuda/faissR_vamana/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
