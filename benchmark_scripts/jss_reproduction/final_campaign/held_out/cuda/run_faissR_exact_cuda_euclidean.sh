...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_exact_cuda_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_exact_cuda_euclidean_%j.err
...
export METHOD_LABEL='faissR_exact_euclidean'
export BACKEND='cuda'
