...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_exact_cuda_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_exact_cuda_cosine_%j.err
...
export METHOD_LABEL='faissR_exact_cosine'
export BACKEND='cuda'
