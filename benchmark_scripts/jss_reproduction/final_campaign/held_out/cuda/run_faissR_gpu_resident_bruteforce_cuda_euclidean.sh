...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_gpu_resident_bruteforce_cuda_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_gpu_resident_bruteforce_cuda_euclidean_%j.err
...
export METHOD_LABEL='faissR_gpu_resident_bruteforce_euclidean'
export BACKEND='cuda'
