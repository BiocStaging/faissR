...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_gpu_resident_bruteforce_cuda_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_gpu_resident_bruteforce_cuda_cosine_%j.err
...
export METHOD_LABEL='faissR_gpu_resident_bruteforce_cosine'
export BACKEND='cuda'
