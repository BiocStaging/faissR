...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_ivfpq_cuda_correlation_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_ivfpq_cuda_correlation_%j.err
...
export METHOD_ID='faissR_cuda_ivfpq'
export METHOD_LABEL='faissR_ivfpq_correlation'
export BACKEND='cuda'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cuda/faissR_ivfpq/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
