...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_gpu_resident_flat_cuda_correlation_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_gpu_resident_flat_cuda_correlation_%j.err
...
export METHOD_ID='faissR_cuda_gpu_resident_flat'
export METHOD_LABEL='faissR_gpu_resident_flat_correlation'
export BACKEND='cuda'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cuda/faissR_gpu_resident_flat/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
