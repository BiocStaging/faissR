...
#SBATCH --job-name="frJ_h_nabor_b_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_nabor_brute_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_nabor_brute_cpu12_euclidean_%j.err
...
export METHOD_ID='nabor_brute'
export METHOD_LABEL='nabor_brute_euclidean'
export BACKEND='cpu'
...
export REQUIRED_EXTERNAL_PACKAGE='nabor'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/nabor_brute/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
