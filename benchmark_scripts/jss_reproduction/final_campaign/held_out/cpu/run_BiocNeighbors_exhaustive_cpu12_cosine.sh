...
#SBATCH --job-name="frJ_h_BiocNei_cosi"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_BiocNeighbors_exhaustive_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_BiocNeighbors_exhaustive_cpu12_cosine_%j.err
...
export METHOD_LABEL='BiocNeighbors_exhaustive_cosine'
export BACKEND='cpu'
