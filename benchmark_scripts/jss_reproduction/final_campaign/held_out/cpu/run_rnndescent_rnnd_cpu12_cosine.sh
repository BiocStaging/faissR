...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_rnndescent_rnnd_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_rnndescent_rnnd_cpu12_cosine_%j.err
...
export METHOD_LABEL='rnndescent_rnnd_cosine'
export BACKEND='cpu'
