...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_BiocNeighbors_hnsw_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_BiocNeighbors_hnsw_cpu12_euclidean_%j.err
...
export METHOD_LABEL='BiocNeighbors_hnsw_euclidean'
export BACKEND='cpu'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/BiocNeighbors_hnsw/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
