...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_rnndescent_rpf_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_rnndescent_rpf_cpu12_cosine_%j.err
...
export METHOD_LABEL='rnndescent_rpf_cosine'
export BACKEND='cpu'
