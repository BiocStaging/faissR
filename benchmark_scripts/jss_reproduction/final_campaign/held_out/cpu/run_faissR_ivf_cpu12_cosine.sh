...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_ivf_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_ivf_cpu12_cosine_%j.err
...
export METHOD_LABEL='faissR_ivf_cosine'
export BACKEND='cpu'
