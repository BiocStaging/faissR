...
#SBATCH --job-name="frJ_h_RANN_kd_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_RANN_kd_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_RANN_kd_cpu12_euclidean_%j.err
...
export METHOD_ID='RANN_kd'
export METHOD_LABEL='RANN_kd_euclidean'
export BACKEND='cpu'
...
export REQUIRED_EXTERNAL_PACKAGE='RANN'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/RANN_kd/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
