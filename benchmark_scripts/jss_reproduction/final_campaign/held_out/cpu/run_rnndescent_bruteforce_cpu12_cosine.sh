...
#SBATCH --job-name="frJ_h_rnndesc_cosi"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_rnndescent_bruteforce_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_rnndescent_bruteforce_cpu12_cosine_%j.err
...
export METHOD_LABEL='rnndescent_bruteforce_cosine'
export BACKEND='cpu'
