...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_grid_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_grid_cpu12_euclidean_%j.err
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/faissR_grid/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
