...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_nndescent_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_nndescent_cpu12_cosine_%j.err
...
export METHOD_LABEL='faissR_nndescent_cosine'
export BACKEND='cpu'
