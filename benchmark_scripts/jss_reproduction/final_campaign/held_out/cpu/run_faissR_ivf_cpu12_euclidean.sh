...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_ivf_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_ivf_cpu12_euclidean_%j.err
...
export METHOD_LABEL='faissR_ivf_euclidean'
export BACKEND='cpu'
