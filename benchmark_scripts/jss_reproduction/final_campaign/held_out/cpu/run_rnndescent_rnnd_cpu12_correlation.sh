...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_rnndescent_rnnd_cpu12_correlation_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_rnndescent_rnnd_cpu12_correlation_%j.err
...
export METHOD_ID='rnndescent_rnnd'
export METHOD_LABEL='rnndescent_rnnd_correlation'
export BACKEND='cpu'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/rnndescent_rnnd/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
