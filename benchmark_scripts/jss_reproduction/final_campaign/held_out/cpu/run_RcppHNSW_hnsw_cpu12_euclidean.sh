...
#SBATCH --job-name="frJ_h_RcppHNS_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_RcppHNSW_hnsw_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_RcppHNSW_hnsw_cpu12_euclidean_%j.err
...
export METHOD_LABEL='RcppHNSW_hnsw_euclidean'
export BACKEND='cpu'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/RcppHNSW_hnsw/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
