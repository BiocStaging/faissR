...
#SBATCH --job-name="frJ_h_rnndesc_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_rnndescent_bruteforce_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_rnndescent_bruteforce_cpu12_euclidean_%j.err
...
export METHOD_LABEL='rnndescent_bruteforce_euclidean'
export BACKEND='cpu'
