...
#SBATCH --job-name="frJ_h_rnndesc_corr"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_rnndescent_bruteforce_cpu12_correlation_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_rnndescent_bruteforce_cpu12_correlation_%j.err
...
export METHOD_ID='rnndescent_bruteforce'
export METHOD_LABEL='rnndescent_bruteforce_correlation'
export BACKEND='cpu'
export THREADS="${THREADS:-12}"
export METHOD_METRICS='correlation'
...
export REQUIRED_EXTERNAL_PACKAGE='rnndescent'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/rnndescent_bruteforce/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
