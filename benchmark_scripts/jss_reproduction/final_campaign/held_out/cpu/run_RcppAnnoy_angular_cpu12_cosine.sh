...
#SBATCH --job-name="frJ_h_RcppAnn_cosi"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_RcppAnnoy_angular_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_RcppAnnoy_angular_cpu12_cosine_%j.err
...
export METHOD_ID='RcppAnnoy_angular'
export METHOD_LABEL='RcppAnnoy_angular_cosine'
export BACKEND='cpu'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/RcppAnnoy_angular/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
