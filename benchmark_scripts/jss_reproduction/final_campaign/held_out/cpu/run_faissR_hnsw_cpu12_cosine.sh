...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_hnsw_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_hnsw_cpu12_cosine_%j.err
...
export METHOD_LABEL='faissR_hnsw_cosine'
export BACKEND='cpu'
