...
#SBATCH --job-name="frJ_h_FNN_cov_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_FNN_cover_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_FNN_cover_cpu12_euclidean_%j.err
...
export METHOD_ID='FNN_cover'
export METHOD_LABEL='FNN_cover_euclidean'
export BACKEND='cpu'
...
export REQUIRED_EXTERNAL_PACKAGE='FNN'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/FNN_cover/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
