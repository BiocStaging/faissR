...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_vamana_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_vamana_cpu12_euclidean_%j.err
