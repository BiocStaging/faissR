...
#SBATCH --job-name="frJ_h_RcppAnn_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_RcppAnnoy_euclidean_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_RcppAnnoy_euclidean_cpu12_euclidean_%j.err
...
export METHOD_ID='RcppAnnoy_euclidean'
export METHOD_LABEL='RcppAnnoy_euclidean_euclidean'
export BACKEND='cpu'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/RcppAnnoy_euclidean/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
