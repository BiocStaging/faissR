...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_ivfpq_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_ivfpq_cpu12_cosine_%j.err
