...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_flat_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_flat_cpu12_cosine_%j.err
...
export METHOD_LABEL='faissR_flat_cosine'
export BACKEND='cpu'
