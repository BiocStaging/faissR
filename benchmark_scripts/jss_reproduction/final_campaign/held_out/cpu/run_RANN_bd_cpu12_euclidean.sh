...
#SBATCH --job-name="frJ_h_RANN_bd_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_RANN_bd_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_RANN_bd_cpu12_euclidean_%j.err
...
export METHOD_LABEL='RANN_bd_euclidean'
export BACKEND='cpu'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/RANN_bd/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
