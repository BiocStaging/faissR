...
#SBATCH --job-name="frJ_h_Rnanofl_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_Rnanoflann_standard_cpu12_euclidean_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_Rnanoflann_standard_cpu12_euclidean_%j.err
...
export METHOD_ID='Rnanoflann_standard'
export METHOD_LABEL='Rnanoflann_standard_euclidean'
export BACKEND='cpu'
...
export REQUIRED_EXTERNAL_PACKAGE='Rnanoflann'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/Rnanoflann_standard/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
