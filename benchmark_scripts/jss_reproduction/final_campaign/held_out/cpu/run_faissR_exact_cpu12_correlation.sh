...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_exact_cpu12_correlation_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_faissR_exact_cpu12_correlation_%j.err
...
export METHOD_ID='faissR_cpu_exact'
export METHOD_LABEL='faissR_exact_correlation'
export BACKEND='cpu'
...
export OUT_DIR="${OUT_DIR:-${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/held_out/cpu/faissR_exact/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)}"
