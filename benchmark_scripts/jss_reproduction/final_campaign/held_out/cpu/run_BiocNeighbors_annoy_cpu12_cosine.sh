...
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hold_BiocNeighbors_annoy_cpu12_cosine_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hold_BiocNeighbors_annoy_cpu12_cosine_%j.err
...
export METHOD_LABEL='BiocNeighbors_annoy_cosine'
export BACKEND='cpu'
