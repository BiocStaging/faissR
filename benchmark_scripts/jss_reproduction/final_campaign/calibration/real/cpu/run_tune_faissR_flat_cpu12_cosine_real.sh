...
#SBATCH --job-name="frJ_t_flat_cosi"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_flat_cpu12_cosine_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_flat_cpu12_cosine_real_%j.err
...
export METHOD='flat'
export METHOD_LABEL='faissR_flat_cosine_real'
export BACKEND='cpu'
