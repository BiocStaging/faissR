...
#SBATCH --job-name="frJ_t_hnsw_cosi"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_hnsw_cpu12_cosine_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_hnsw_cpu12_cosine_real_%j.err
...
export METHOD='hnsw'
export METHOD_LABEL='faissR_hnsw_cosine_real'
export BACKEND='cpu'
