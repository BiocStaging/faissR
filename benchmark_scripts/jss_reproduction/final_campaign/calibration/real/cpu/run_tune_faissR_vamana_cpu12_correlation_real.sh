...
#SBATCH --job-name="frJ_t_vamana_corr"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_vamana_cpu12_correlation_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_vamana_cpu12_correlation_real_%j.err
...
export METHOD_LABEL='faissR_vamana_correlation_real'
export BACKEND='cpu'
