...
#SBATCH --job-name="frJ_t_hnsw_corr"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_hnsw_cpu12_correlation_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_hnsw_cpu12_correlation_real_%j.err
...
export METHOD='hnsw'
export METHOD_LABEL='faissR_hnsw_correlation_real'
export BACKEND='cpu'
