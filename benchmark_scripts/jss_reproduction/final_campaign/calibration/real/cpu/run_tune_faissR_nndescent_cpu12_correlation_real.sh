...
#SBATCH --job-name="frJ_t_nndesce_corr"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_nndescent_cpu12_correlation_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_nndescent_cpu12_correlation_real_%j.err
...
export METHOD_LABEL='faissR_nndescent_correlation_real'
export BACKEND='cpu'
export METRICS='correlation'
...
export OUT_DIR="${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/calibration/real/cpu/${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)"
