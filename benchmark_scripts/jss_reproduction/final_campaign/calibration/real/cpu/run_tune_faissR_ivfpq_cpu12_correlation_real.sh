...
#SBATCH --job-name="frJ_t_ivfpq_corr"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_cpu12_correlation_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_cpu12_correlation_real_%j.err
...
export METHOD='ivfpq'
export METHOD_LABEL='faissR_ivfpq_correlation_real'
export BACKEND='cpu'
