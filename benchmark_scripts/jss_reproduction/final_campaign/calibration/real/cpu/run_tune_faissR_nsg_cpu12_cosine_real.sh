...
#SBATCH --job-name="frJ_t_nsg_cosi"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_nsg_cpu12_cosine_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_nsg_cpu12_cosine_real_%j.err
...
export METHOD='nsg'
export METHOD_LABEL='faissR_nsg_cosine_real'
export BACKEND='cpu'
