...
#SBATCH --job-name="frJ_t_ivfpq_cosi"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_cpu12_cosine_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_cpu12_cosine_real_%j.err
...
export METHOD='ivfpq'
export METHOD_LABEL='faissR_ivfpq_cosine_real'
export BACKEND='cpu'
