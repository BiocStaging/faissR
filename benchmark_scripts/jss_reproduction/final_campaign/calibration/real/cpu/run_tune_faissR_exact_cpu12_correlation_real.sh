...
#SBATCH --job-name="frJ_t_exact_corr"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_exact_cpu12_correlation_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_exact_cpu12_correlation_real_%j.err
...
export METHOD='exact'
export METHOD_LABEL='faissR_exact_correlation_real'
export BACKEND='cpu'
