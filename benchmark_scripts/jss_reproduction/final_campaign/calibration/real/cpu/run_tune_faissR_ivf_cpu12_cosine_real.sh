...
#SBATCH --job-name="frJ_t_ivf_cosi"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivf_cpu12_cosine_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivf_cpu12_cosine_real_%j.err
...
export METHOD='ivf'
export METHOD_LABEL='faissR_ivf_cosine_real'
export BACKEND='cpu'
