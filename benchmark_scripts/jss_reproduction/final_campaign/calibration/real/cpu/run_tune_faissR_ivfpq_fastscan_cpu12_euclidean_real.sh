...
#SBATCH --job-name="frJ_t_ivfpq_f_eucl"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_fastscan_cpu12_euclidean_real_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_tune_ivfpq_fastscan_cpu12_euclidean_real_%j.err
...
export METHOD_LABEL='faissR_ivfpq_fastscan_euclidean_real'
export BACKEND='cpu'
