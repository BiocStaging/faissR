...
#SBATCH --job-name="frJ_resume_gpu"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_resume_cuda_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_resume_cuda_%j.err
...
tmp_launcher="$(mktemp "${TMPDIR:-/tmp}/faissR_resume_cuda_XXXXXX.sh")"
