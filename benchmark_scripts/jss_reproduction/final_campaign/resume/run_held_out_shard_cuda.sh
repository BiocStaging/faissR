...
#SBATCH --job-name="frJ_hres_gpu"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_heldout_resume_cuda_%A_%a.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_heldout_resume_cuda_%A_%a.err
...
export SHARD_OUT_DIR="${HELD_OUT_RESULTS_ROOT}/cuda/resume/${SLURM_ARRAY_JOB_ID}_${TASK_ID}_${DATASET_LABEL}"
mkdir -p "${SHARD_OUT_DIR}"

tmp_launcher="$(mktemp "${TMPDIR:-/tmp}/faissR_heldout_cuda_XXXXXX.sh")"
