...
export OUT_DIR="${BASE_DIR}/faissR_JSS_REPRODUCTION/final_campaign/analysis/metric_conformance/cuda_${SLURM_JOB_ID:-manual}_$(date +%Y%m%d_%H%M%S)"
export SINGULARITY_IMAGE
exec bash "${SUITE_ROOT}/validation/run_metric_conformance_cuda.sh"
