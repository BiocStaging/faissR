...
sbatch benchmark_scripts/jss_reproduction/refresh_tabula_muris/run_references_cuda.sh
```

Wait for this job to finish. It regenerates all three metric references for
...
export METRICS=euclidean,cosine,correlation
```
...
```bash
sbatch --export=ALL,DATASETS=TabulaMuris benchmark_scripts/jss_reproduction/cpu/run_faissR_hnsw_cpu12.sh
sbatch --export=ALL,DATASETS=TabulaMuris benchmark_scripts/jss_reproduction/cuda/run_faissR_cagra_cuda.sh
```
...
```bash
sbatch --export=ALL,DATASETS=TabulaMuris benchmark_scripts/jss_reproduction/ablations/run_systems_ablations_cpu12.sh
sbatch --export=ALL,DATASETS=TabulaMuris benchmark_scripts/jss_reproduction/ablations/run_systems_ablations_cuda.sh
```
