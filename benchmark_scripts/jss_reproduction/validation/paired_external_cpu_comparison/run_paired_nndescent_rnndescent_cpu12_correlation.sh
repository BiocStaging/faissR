...
#SBATCH --job-name="frJ_pair_nnd_r"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_pair_nnd_r_%A_%a.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_pair_nnd_r_%A_%a.err
