...
#SBATCH --job-name="frJ_hp_sel"
#SBATCH --chdir=/scratch/firenze/NN
#SBATCH --output=/scratch/firenze/NN/benchmark_logs/frJ_hp_sel_%j.out
#SBATCH --error=/scratch/firenze/NN/benchmark_logs/frJ_hp_sel_%j.err
set -euo pipefail
...
Rscript "${SUITE_ROOT}/validation/paired_cpu_hnsw_pareto/select_configurations.R" --root="${ROOT}"
