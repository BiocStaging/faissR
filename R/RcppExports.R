...
row_candidate_knn_cuda_cpp <- function(data, candidate_indices, k, metric, fill_missing = TRUE) {
    .Call(`_faissR_row_candidate_knn_cuda_cpp`, data, candidate_indices, k, metric, fill_missing)
}
